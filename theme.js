(function () {
  ...
  function getBulbIcon(targetTheme) {
    ...
    const fill = isLightTarget ? "currentColor" : "none";

    return `<svg class="bulb-icon ${isLightTarget ? "bulb-icon-on" : "bulb-icon-off"}" aria-hidden="true" viewBox="0 0 24 24" focusable="false"><path d="M9 21h6"/><path d="M10 17h4"/><path d="M12 3a6 6 0 0 0-3.6 10.8c.9.7 1.6 1.8 1.6 3.2h4c0-1.4.7-2.5 1.6-3.2A6 6 0 0 0 12 3Z" fill="${fill}"/><path d="M12 1v1"/><path d="M4.2 4.2l.7.7"/><path d="M19.8 4.2l-.7.7"/><path d="M3 12h1"/><path d="M20 12h1"/></svg>`;
  }
